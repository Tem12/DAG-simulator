...
# Required params
MAX_INSTANCES = 3
CONFIGS = ['configs/btc-payoff_2h_2m-40-v1.cfg', 'configs/btc-payoff_3h_1m-40-v1.cfg', 'configs/btc-payoff_4h_0m-40-v1.cfg']
SEEDS = [512, 1022, 42]
...
def create_simulation_queue():
    ...
    for config in CONFIGS:
        for seed in SEEDS:
            simulations.append(
                run_base + ['--seed', f'{seed}', '--config', f'{config}'])
